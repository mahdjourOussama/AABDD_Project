...
public class Cat_Table extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        categorie_Table = new javax.swing.JTable();

        categorie_Table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(categorie_Table);
        if (categorie_Table.getColumnModel().getColumnCount() > 0) {
            categorie_Table.getColumnModel().getColumn(0).setResizable(false);
            categorie_Table.getColumnModel().getColumn(1).setResizable(false);
        }
    ...
    public javax.swing.JTable categorie_Table;
